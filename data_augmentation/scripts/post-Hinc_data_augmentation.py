...
source_image_dimensions = (1280, 1024)  # the dimensions of the source images (5:4)
crop_dimensions = (256, 256)  # 1024x1024 are the recommended largest dimensions
...
new_dir_name = str("Post-Hinc" + crop_dimensions[0]) + "_" + str(crop_dimensions[1])
if pool:
    new_dir_name = new_dir_name + "pooled_to" + str(pool_dimensions[0]) + "_" + str(pool_dimensions[1])
...
for x in range(math.floor(source_image_dimensions[0]/crop_dimensions[0])):
    for y in range(math.floor(source_image_dimensions[1]/crop_dimensions[1])):
