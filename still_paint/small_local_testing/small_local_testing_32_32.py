...
train_batches = keras.preprocessing.image.ImageDataGenerator(preprocessing_function = tf.keras.applications.vgg16.preprocess_input).flow_from_directory(directory = data_directory, target_size = (32,32), classes = dispersion_times, batch_size = 128g)
